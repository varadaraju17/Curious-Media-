  ...
  return (
    <section ref={containerRef} className="py-32 md:py-64 relative z-10 bg-black overflow-hidden border-t border-white/5">
      ...
      <div className="container mx-auto px-4 md:px-8 max-w-6xl relative z-10">
        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black font-heading leading-[0.9] tracking-tighter flex flex-wrap gap-x-4 md:gap-x-8 gap-y-2 md:gap-y-6">
