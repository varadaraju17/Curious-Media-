...
export function Hero({ dict, locale }: { dict: any; locale: Locale }) {
  ...
  return (
    <section ref={container} className="relative min-h-[110vh] flex items-center justify-center overflow-hidden bg-black text-white selection:bg-white/30 pt-20">
      ...
      <motion.div style={{ y, opacity }} className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[80vw] h-[50vh] bg-white/5 blur-[120px] rounded-full pointer-events-none mix-blend-screen"></motion.div>
      ...
      <div className="container relative z-10 px-4 md:px-8 mx-auto flex flex-col items-center justify-center text-center">
        ...
        <motion.h1
          ...
          className="text-[10vw] md:text-[8vw] leading-[0.9] font-black font-heading tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white via-white/90 to-black/20"
        >
          WHERE BRANDS<br/>
          MEET CREATORS.
        </motion.h1>
        ...
        >
           <Link 
             href={`/${locale}/media`} 
             className="group relative inline-flex items-center justify-center gap-3 overflow-hidden rounded-full bg-white px-8 py-4 text-black font-bold tracking-wide transition-all hover:scale-105 hover:bg-gray-200"
           >
