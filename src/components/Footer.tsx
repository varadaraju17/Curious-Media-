        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="col-span-1 md:col-span-5">
            <Link href={`/${locale}`} className="inline-flex items-center gap-3 mb-4 group">
              <img src="/images/logo.svg" alt="Curious Media Logo" width="48" height="48" loading="lazy" decoding="async" className="h-10 md:h-12 w-auto object-contain transition-transform duration-300 group-hover:scale-105" />
