    ...
    <main className="flex-1 w-full bg-white relative overflow-hidden min-h-screen flex flex-col items-center justify-center pt-24 pb-12">
      ...
      <div className="container mx-auto px-4 relative z-10 text-center max-w-6xl flex flex-col items-center">
        ...
        >
          ...
          <span className="text-xs font-black tracking-[0.25em] uppercase text-[#0B2EA8]">Curious Records</span>
        </motion.div>
        ...
        >
          Something legendary is in the works. We are building the next generation <br className="hidden md:block" /> of independent music publishing and artist discovery.
        </motion.p>
