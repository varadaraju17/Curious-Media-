      ...
      <section className="py-32 px-4 md:px-8 bg-white border-t border-slate-100">
        <div className="container mx-auto max-w-7xl">
          <motion.div 
            ...
            className="rounded-[3rem] md:rounded-[4rem] bg-[#0A1A4E] relative overflow-hidden shadow-[0_40px_120px_rgba(10,26,78,0.35)]"
          >
            {/* Ambient background */}
            ...
            <div className="relative z-10 px-10 md:px-16 lg:px-24 py-12 md:py-16 grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              >
                <div className="flex flex-col gap-1">
                  ...
                  <span className="text-3xl md:text-4xl font-black uppercase tracking-tight">Partner With Us</span>
                </div>
